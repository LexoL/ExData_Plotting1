...
with(tbl.consumption, plot(Date+Time, Sub_metering_1, type = "l", lwd = 1,
                           ylab = "Energy sub metering", xlab = ""))
with(tbl.consumption, lines(Date+Time, Sub_metering_2, type = "l", lwd = 1,
                          col = "red"))
with(tbl.consumption, lines(Date+Time, Sub_metering_3, type = "l", lwd = 1,
                            col = "blue"))
